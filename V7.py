...
{green}│                                                                     {green}   │
{green}│ {hotpink}           $$\    $$\ $$\                              {green}                │ 
{green}│  {hotpink}          $$ |   $$ |\__|                                    {green}         │
{green}│  {hotpink}          $$ |   $$ |$$\  $$$$$$\  $$\   $$\  $$$$$$$\            {green}    │
{green}│ {hotpink}           \$$\  $$  |$$ |$$  __$$\ $$ |  $$ |$$  _____|          {green}     │
{green}│    {hotpink}         \$$\$$  / $$ |$$ |  \__|$$ |  $$ |\$$$$$$\               {green}  │
{green}│     {hotpink}         \$$$  /  $$ |$$ |      $$ |  $$ | \____$$\            {green}    │
{green}│     {hotpink}          \$  /   $$ |$$ |      \$$$$$$  |$$$$$$$  |           {green}    │
{green}│  {hotpink}              \_/    \__|\__|       \______/ \_______/             {green}   │
...
{hotpink}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓\033[0m""")
    ...
    print(f"{hotpink}┃  {green}[02]  {white}𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓 𝐏𝐎𝐒𝐓                      {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]    {hotpink}    ┃")
    print(f"{hotpink}┃  {green}[03]  {white}𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓 𝐑𝐄𝐄𝐋𝐒                     {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]      {hotpink}  ┃")
    print(f"{hotpink}┃  {green}[04]  {white}𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓 𝐆𝐑𝐎𝐔𝐏 𝐏𝐎𝐒𝐓                {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {hotpink}   ┃")
    print(f"{hotpink}┃  {green}[05]  {white}𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓 [ 𝐕𝐈𝐃𝐄𝐎 𝐎𝐑 𝐏𝐇𝐎𝐓𝐎 ]        {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {hotpink}   ┃")
    print(f"{hotpink}┃  {green}[06]  {white}𝐀𝐔𝐓𝐎 𝐅𝐎𝐋𝐋𝐎𝐖                          {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]       {hotpink} ┃")
    print(f"{hotpink}┃  {green}[07]  {white}𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓 𝐃𝐏/𝐏𝐎𝐒𝐓                   {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]    {hotpink}    ┃")
    print(f"{hotpink}┃  {green}[08]  {white}𝐀𝐔𝐓𝐎 𝐂𝐎𝐌𝐌𝐄𝐍𝐓𝐒                        {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {hotpink}   ┃")
    print(f"{hotpink}┃  {green}[09]  {white}𝐀𝐔𝐓𝐎 𝐅𝐎𝐋𝐋𝐎𝐖 & 𝐋𝐈𝐊𝐄 𝐏𝐀𝐆𝐄              {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]    {hotpink}    ┃")
    print(f"{hotpink}┃  {green}[10]  {white}𝐀𝐔𝐓𝐎 𝐒𝐇𝐀𝐑𝐄 [ 𝐕𝐈𝐀 𝐂𝐎𝐎𝐊𝐈𝐄𝐒 ]           {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]      {hotpink}  ┃")
    print(f"{hotpink}┃  {green}[11]  {white}𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓 𝐂𝐎𝐌𝐌𝐄𝐍𝐓𝐒                  {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {hotpink}   ┃")
    print(f"{hotpink}┃  {green}[12]  {white}𝐀𝐔𝐓𝐎 𝐑𝐄𝐏𝐋𝐘 𝐂𝐎𝐌𝐌𝐄𝐍𝐓𝐒                  {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {hotpink}   ┃")
    print(f"{hotpink}┃  {green}[13]  {white}𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓 𝐏𝐎𝐒𝐓 ( 𝐖/𝐂𝐀𝐑𝐄 )           {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {hotpink}   ┃")
    print(f"{hotpink}┃  {green}[14]  {white}𝐀𝐔𝐓𝐎 𝐆𝐑𝐎𝐔𝐏 𝐉𝐎𝐈𝐍                      {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {hotpink}   ┃")
    print(f"{hotpink}┃  {green}[15]  {white}𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓 𝐋𝐈𝐕𝐄 𝐒𝐓𝐑𝐄𝐀𝐌               {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {hotpink}   ┃")
    print(f"{hotpink}┃  {green}[16]  {white}𝐀𝐔𝐓𝐎 𝐂𝐎𝐌𝐌𝐄𝐍𝐓 𝐋𝐈𝐕𝐄 𝐒𝐓𝐑𝐄𝐀𝐌             {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {hotpink}   ┃")
    print(f"{hotpink}┃  {green}[17]{white}  𝐑𝐄𝐒𝐄𝐓 𝐓𝐎𝐎𝐋𝐒                          {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]      {hotpink}  ┃")
    print(f"{hotpink}┃  {green}[18]{white}  𝐀𝐔𝐓𝐎 𝐂𝐑𝐄𝐀𝐓𝐄 𝐏𝐀𝐆𝐄                     {yellow}- {green}[ 𝐏𝐇 𝐍𝐀𝐌𝐄 ]          {hotpink}      ┃")
    print(f"{hotpink}┃  {green}[19] {white} 𝐀𝐔𝐓𝐎 𝐒𝐄𝐓 𝐏𝐅𝐎𝐅𝐈𝐋𝐄                     {yellow}- {green}[ 𝐑𝐀𝐍𝐃𝐎𝐌 ]             {hotpink}    ┃")
    print(f"{hotpink}┃  {green}[20] {white} 𝐂𝐑𝐄𝐀𝐓𝐄 𝐅𝐈𝐋𝐄                          {yellow}- {green}[ 𝐑𝐀𝐍𝐃𝐎𝐌 ]            {hotpink}     ┃")
    print(f"{hotpink}┃  {green}[21] {white} 𝐑𝐄𝐌𝐎𝐕𝐄 𝐃𝐔𝐏𝐋𝐈𝐂𝐀𝐓𝐄                     {yellow}- {green}[ 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 𝐑𝐎𝐌𝐎𝐕𝐄𝐑 ]    {hotpink}    ┃")
    print(f"{hotpink}┃  {green}[22]  {white}𝐀𝐂𝐂𝐎𝐔𝐍𝐓 𝐂𝐇𝐄𝐂𝐊𝐄𝐑                      {yellow}- {green}[ 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 𝐂𝐇𝐄𝐂𝐊𝐄𝐑 ]  {hotpink}      ┃")
    print(f"{hotpink}┃  {green}[23]  {white}𝐕𝐀𝐋𝐈𝐃𝐀𝐓𝐄 𝐓𝐎𝐊𝐄𝐍                       {yellow}- {green}[ 𝐓𝐎𝐊𝐄𝐍 ]             {hotpink}     ┃")
    print(f"{hotpink}┃  {green}[24]  {white}𝐑𝐄𝐃𝐄𝐄𝐌 𝐀𝐂𝐂𝐎𝐔𝐍𝐓                       {yellow}- {green}[ 𝐑𝐄𝐃𝐄𝐌𝐓𝐈𝐎𝐍𝐒 ]      {hotpink}       ┃") 
    print(f"{hotpink}┃  {green}[25]  {white}𝐀𝐔𝐓𝐎 𝐒𝐇𝐀𝐑𝐄 𝐕1                        {yellow}- {green}[ 𝐅𝐀𝐒𝐓 𝐒𝐏𝐄𝐄𝐃 / 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 ] {hotpink}  ┃") 
    print(f"{hotpink}┃  {green}[26]  {white}𝐀𝐔𝐓𝐎 𝐒𝐇𝐀𝐑𝐄 𝐕2                        {yellow}- {green}[ 𝐅𝐀𝐒𝐓 𝐒𝐏𝐄𝐄𝐃 / 𝐏𝐔𝐁𝐋𝐈𝐂 ]   {hotpink} ┃") 
